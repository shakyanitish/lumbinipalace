  ...
  return this.each(function() {
  	    // Check password strength ~~~~~~~~~~~~~~~~~~~~~
		    jQuery(o.main).keyup(function(){
	  		...
	  		var strength = evalScore(s);	
	  		// Display Score
	  		//jQuery('#psr_score').html('Strength: <span class=psr_'+levels[strength]+'>'+levels[strength]+'</span>');	
			jQuery('#psr_score').html('<div class="col-md-2"></div><div class="col-md-4 infobox infobox-close-wrapper info-bg" style="margin-bottom:0% !important;"><a href="javascript:void(0);" onClick="removestrengthmsg();" title="Close Message" class="glyph-icon infobox-close icon-remove strangthmsg"></a><p>Strength : '+levels[strength]+'</p></div>');
	    });
	...
	if(o.verify!=null){
		...
		/*jQuery(o.verify).blur(function(){
		   ...
		   var verify = jQuery(o.verify).val();
		   if(main!=verify){
			   jQuery('#psr_verify').html('<div class="col-md-2"></div><div class="col-md-4 infobox infobox-close-wrapper bg-orange" style="margin-bottom:0% !important;"><a href="javascript:void(0);" onClick="removematchmsg();" title="Close Message" class="glyph-icon infobox-close icon-remove matchmsg"></a><p>Passwords do not match</p></div>');
			   changeButtonState(0);
		   }
		});*/
	}
