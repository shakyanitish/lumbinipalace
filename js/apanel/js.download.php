...
$(document).ready(function () {
    ...
    var desiredPage = localStorage.getItem("downloaddbpage") ? parseInt(localStorage.getItem("downloaddbpage")) : 0;
    var desiredLength = localStorage.getItem("downloaddblength") ? parseInt(localStorage.getItem("downloaddblength")) : 10;
    ...
    $(document).on("click", ".fg-button", function () {
        ...
        localStorage.setItem("downloaddbpage", currentPage);
    ...
    $(document).on('change', '#example_length select', function () {
        ...
        localStorage.setItem("downloaddblength", selectedLength);
