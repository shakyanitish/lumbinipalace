...
$(document).ready(function () {
    ...
    var desiredPage = localStorage.getItem("newsdbpage") ? parseInt(localStorage.getItem("newsdbpage")) : 0;
    var desiredLength = localStorage.getItem("newsdblength") ? parseInt(localStorage.getItem("newsdblength")) : 10;
    ...
    $(document).on("click", ".fg-button", function () {
        ...
        localStorage.setItem("newsdbpage", currentPage);
    ...
    $(document).on('change', '#example_length select', function () {
        ...
        localStorage.setItem("newsdblength", selectedLength);
