...
$(document).ready(function () {
    ...
    var desiredPage = localStorage.getItem("popupdbpage") ? parseInt(localStorage.getItem("popupdbpage")) : 0;
    var desiredLength = localStorage.getItem("popupdblength") ? parseInt(localStorage.getItem("popupdblength")) : 10;
    ...
    $(document).on("click", ".fg-button", function () {
        ...
        localStorage.setItem("popupdbpage", currentPage);
    ...
    $(document).on('change', '#example_length select', function () {
        ...
        localStorage.setItem("popupdblength", selectedLength);
