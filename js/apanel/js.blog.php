...
$(document).ready(function () {
    ...
    var desiredPage = localStorage.getItem("blogdbpage") ? parseInt(localStorage.getItem("blogdbpage")) : 0;
    var desiredLength = localStorage.getItem("blogdblength") ? parseInt(localStorage.getItem("blogdblength")) : 10;
    ...
    $(document).on("click", ".fg-button", function () {
        ...
        localStorage.setItem("blogdbpage", currentPage);
    ...
    $(document).on('change', '#example_length select', function () {
        ...
        localStorage.setItem("blogdblength", selectedLength);
