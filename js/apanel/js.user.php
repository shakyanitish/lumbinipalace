...
$(document).ready(function () {
    ...
    var desiredPage = localStorage.getItem("userdbpage") ? parseInt(localStorage.getItem("userdbpage")) : 0;
    var desiredLength = localStorage.getItem("userdblength") ? parseInt(localStorage.getItem("userdblength")) : 10;
    ...
    var oTable = $('#example').dataTable({
        ...
        sURL: "<?php echo BASE_URL;?>includes/controllers/ajax.user.php?action=sort",
    ...
    $(document).on("click", ".fg-button", function () {
        ...
        localStorage.setItem("userdbpage", currentPage);
    ...
    $(document).on('change', '#example_length select', function () {
        ...
        localStorage.setItem("userdblength", selectedLength);
