...
$(document).ready(function () {
    ...
    var desiredPage = localStorage.getItem("subscribersdbpage") ? parseInt(localStorage.getItem("subscribersdbpage")) : 0;
    var desiredLength = localStorage.getItem("subscribersdblength") ? parseInt(localStorage.getItem("subscribersdblength")) : 10;
    ...
    var oTable = $('#example').dataTable({
        ...
        sURL: "<?php echo BASE_URL;?>includes/controllers/ajax.subscribers.php?action=sort",
    ...
    $(document).on("click", ".fg-button", function () {
        ...
        localStorage.setItem("subscribersdbpage", currentPage);
    ...
    $(document).on('change', '#example_length select', function () {
        ...
        localStorage.setItem("subscribersdblength", selectedLength);
