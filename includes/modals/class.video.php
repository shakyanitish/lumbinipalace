...
class Video extends DatabaseObject {
	...
	protected static $db_fields = array('id', 'source', 'url_type', 'title', 'thumb_image', 'url', 'content', 'class', 'host', 'status', 'sortorder', 'added_date','meta_title', 'meta_keywords', 'meta_description');
