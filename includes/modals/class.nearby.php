...
class Nearby extends DatabaseObject {
	...
	protected static $db_fields = array('id', 'parent_id', 'slug', 'title', 'sub_title', 'linksrc', 'linktype', 'content', 'status','google_embeded', 'sortorder', 'meta_title', 'meta_keywords', 'meta_description', 'type', 'added_date', 'modified_date','homepage', 'image', 'distance');
