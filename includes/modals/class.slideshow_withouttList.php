...
class Slideshow extends DatabaseObject {
	...
	protected static $table_name = "tbl_slideshows";
	protected static $db_fields = array('id', 'title', 'image', 'status', 'sortorder', 'type', 'registered');
	...
	// frontend records
	public static function get_all_slideshow(){
		global $db;
