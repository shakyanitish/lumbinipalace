...
class FaqCategory extends DatabaseObject
{

    protected static $table_name = "tbl_faq_category";
    protected static $db_fields = array('id', 'title', 'icon', 'status', 'sortorder', 'added_date', 'modified_date');

    public $id, $title, $icon, $status, $sortorder, $added_date, $modified_date;
