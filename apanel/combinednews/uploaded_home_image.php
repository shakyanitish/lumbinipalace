        ...
        <div class="form-row">
            ...
            <div class="col-md-3" id="previewUserimage<?php echo $deleteid;?>">
                <div class="infobox info-bg">
                    <img src="<?php echo IMAGE_PATH.'combinednews/home/thumbnails/'.$val;?>"  style="width:100%"/>
...
if(isset($_SESSION['imageNameArr'])){
    if(count($_SESSION['imageNameArr'])>0){
        ...
        {
            @unlink(IMAGE_PATH.'combinednews/home/thumbnails/'.$val);
            @unlink(IMAGE_PATH.'combinednews/home/'.$val);
        }
