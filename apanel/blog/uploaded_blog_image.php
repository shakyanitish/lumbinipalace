...
if(!isset($_SESSION['blogImageNameArr'])){ $_SESSION['blogImageNameArr']=array(); }
$_SESSION['blogImageNameArr'][] = $_POST['imagefile']; 
...
<div class="col-md-3" id="previewUserimage<?php echo $deleteid;?>">
    <div class="infobox info-bg">
        <img src="<?php echo IMAGE_PATH.'blog/blogimages/thumbnails/'.$newImage;?>" style="width:100%"/>
        <a href="javascript:void(0);" onclick="deleteTempBlogimage(<?php echo $deleteid;?>);">
