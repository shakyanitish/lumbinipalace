        ...
        <div class="col-md-3" id="previewRoomsimage<?php echo $deleteid; ?>">
            <div class="infobox info-bg">
                ...
                <a href="javascript:void(0);" onclick="deleteTempimage(<?php echo $deleteid; ?>);">
                    <span class="badge badge-absolute float-right bg-red" style="right: -10px !important;"><i
                            class="glyph-icon icon-clock-os"></i></span>
                </a>
                <input type="hidden" name="imageArrayname360" value="<?php echo $val; ?>"
