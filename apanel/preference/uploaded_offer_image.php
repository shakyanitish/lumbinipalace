        ...
        <div class="form-row">
            ...
            <div class="col-md-2" id="previewUserimage<?php echo $deleteid; ?>">
                <div class="infobox info-bg">
                    <img src="<?php echo IMAGE_PATH . 'preference/offer/thumbnails/' . $val; ?>" style="width:100%"/>
                    ...
                    <input type="hidden" name="imageArrayname9" value="<?php echo $val; ?>"
...
if (isset($_SESSION['imageNameArr'])) {
    if (count($_SESSION['imageNameArr']) > 0) {
        foreach ($_SESSION['imageNameArr'] as $key => $val) {
            @unlink(IMAGE_PATH . 'preference/offer/thumbnails/' . $val);
            @unlink(IMAGE_PATH . 'preference/offer/' . $val);
        }
