                ...
                <form action="" class="col-md-12 center-margin" id="package_frm">
                    ...
                    <div class="events-only-fields" style="display: none;">
                        ...
                        <div class="form-row mb-3">
                            <div class="form-label col-md-2">
                                <label for="events_room">No. of Event Room :</label>
                            </div>
                            <div class="form-input col-md-3">
                                <input placeholder="Events Room" class="form-control validate[length[0,200]]" type="text"
                                    name="events_room" id="events_room"
                                    value="<?php echo !empty($packageInfo->events_room) ? $packageInfo->events_room : ''; ?>">
                            </div>

                            <div class="form-label col-md-2">
                                <label for="total_event_space">Total Event Space :</label>
                            </div>
                            <div class="form-input col-md-3">
                                <input placeholder="Total Event Space" class="form-control validate[length[0,200]]" type="text"
                                    name="total_event_space" id="total_event_space"
                                    value="<?php echo !empty($packageInfo->total_event_space) ? $packageInfo->total_event_space : ''; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-row mb-3">
                            <div class="form-label col-md-2">
                                <label for="capacity_largest_space">Capacity Largest Space :</label>
                            </div>
                            <div class="form-input col-md-3">
                                <input placeholder="Capacity Largest Space" class="form-control validate[length[0,200]]" type="text"
                                    name="capacity_largest_space" id="capacity_largest_space"
                                    value="<?php echo !empty($packageInfo->capacity_largest_space) ? $packageInfo->capacity_largest_space : ''; ?>">
                            </div>

                            <div class="form-label col-md-2">
                                <label for="breakout_rooms">Breakout Rooms :</label>
                            </div>
                            <div class="form-input col-md-3">
                                <input placeholder="Breakout Rooms" class="form-control validate[length[0,200]]" type="text"
                                    name="breakout_rooms" id="breakout_rooms"
                                    value="<?php echo !empty($packageInfo->breakout_rooms) ? $packageInfo->breakout_rooms : ''; ?>">
                            </div>
                        </div>
    ...
    -->
                            ...
                            <div class="" id="includes_sortable">
                                ...
                                if (sizeof($savedIncludes) > 0 && is_array($savedIncludes)) {
                                    foreach ($savedIncludes as $childKey => $childRow) {
                                        ...
                                        $incLinkType = is_array($childRow) ? (isset($childRow['linktype']) ? $childRow['linktype'] : 1) : 1;
                                ?>
                                        <div class="mrg10B" style="background: #f9f9f9; padding: 15px; border-radius: 4px; margin-bottom: 15px;">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-checkbox-radio col-md-9">
                                                    <input type="radio" class="custom-radio" name="incexc_linktype[<?php echo $childKey; ?>]" value="0" onclick="includeLinkTypeSelect(this);" <?php echo ($incLinkType == 0) ? 'checked' : ''; ?>>
                                                    <label>Internal Link</label>
                                                    <input type="radio" class="custom-radio" name="incexc_linktype[<?php echo $childKey; ?>]" value="1" onclick="includeLinkTypeSelect(this);" <?php echo ($incLinkType == 1) ? 'checked' : ''; ?>>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-input col-md-8">
                                                    <div class="col-md-4" style="padding-left: 0px !important;">
                                                        <input placeholder="Menu Link" class="form-control incexc-url-input" type="text" name="incexc_url[<?php echo $childKey; ?>]" value="<?php echo $incUrl; ?>">
                                                    </div>
                                                    <div class="col-md-6" style="padding-left: 0px !important; display: <?php echo ($incLinkType == 0) ? 'block' : 'none'; ?>">
                                                        <select data-placeholder="Select Link Page" class="form-control chosen-select incexc-page-select">
                                                            <option value=""></option>
                                                            <?php
                                                            $Lpageview = $incUrl;
                                                            $LinkTypeview = $incLinkType;
                                                            // Article Page Link
                                                            echo Article::get_internal_link($Lpageview, $LinkTypeview);
                                                            // Services Page Link
                                                            echo Services::get_internal_link($Lpageview, $LinkTypeview);
                    ...
                    <!-- Shown for both Events (type==3) and Experiences (type==2) -->
                    <div class="events-and-experiences-fields" style="display: none;">
                        <!-- Includes with url -->
                        <div class="form-row multi-discount">
                            <div class="form-label col-md-2">
                                <label for="">Includes :</label>
                                ...
                                <div class="" id="includes_sortable_2">
                                    ...
                                    if (sizeof($savedIncludes) > 0 && is_array($savedIncludes)) {
                                        foreach ($savedIncludes as $childKey => $childRow) {
                                            ...
                                            $incUrl = is_array($childRow) ? (!empty($childRow['url']) ? $childRow['url'] : '') : '';
                                            $incLinkType = is_array($childRow) ? (isset($childRow['linktype']) ? $childRow['linktype'] : 1) : 1;
                                            $incSubtitle = is_array($childRow) ? (!empty($childRow['subtitle']) ? $childRow['subtitle'] : '') : '';
                                    ?>
                                            <div class="mrg10B" style="background: #f9f9f9; padding: 15px; border-radius: 4px; margin-bottom: 15px;">
                                                <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 15px;">
                                                    <span class="drag-handle cp" style="cursor: move;"><i class="glyph-icon icon-arrows"></i></span>
                                                ...
                                                <div class="subtitle-field" style="display: <?php echo ($packageInfo->type == 2) ? 'flex' : 'none'; ?>; align-items: center; gap: 10px; margin-bottom: 15px;">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-checkbox-radio col-md-9">
                                                        <input type="radio" class="custom-radio" name="incexc_linktype1[<?php echo $childKey; ?>]" value="0" onclick="includeLinkTypeSelect(this);" <?php echo ($incLinkType == 0) ? 'checked' : ''; ?>>
                                                        <label>Internal Link</label>
                                                        <input type="radio" class="custom-radio" name="incexc_linktype1[<?php echo $childKey; ?>]" value="1" onclick="includeLinkTypeSelect(this);" <?php echo ($incLinkType == 1) ? 'checked' : ''; ?>>
                                                        <label>External Link</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-input col-md-8">
                                                        <div class="col-md-4" style="padding-left: 0px !important;">
                                                            <input placeholder="Menu Link" class="form-control incexc-url-input" type="text" name="incexc_url1[<?php echo $childKey; ?>]" value="<?php echo $incUrl; ?>">
                                                        </div>
                                                        <div class="col-md-6" style="padding-left: 0px !important; display: <?php echo ($incLinkType == 0) ? 'block' : 'none'; ?>">
                                                            <select data-placeholder="Select Link Page" class="form-control chosen-select incexc-page-select">
                                                                <option value=""></option>
